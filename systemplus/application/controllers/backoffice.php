            ...
            foreach ($data["all_books"] as $singbk) {
                ...
                if (count($singbk["all_acco"])) {
                    foreach ($singbk["all_acco"] as $singacco) {
                        $rigaData = '"' . $singbk["centro"] . '";"' . $singbk["id_year"] . "_" . $singbk["id_book"] . '";"' . $singbk["agency"][0]["businessname"] . '";"' . $singbk["arrival_date"] . '";"' . $singbk["departure_date"] . '";"' . $singbk["weeks"] . '";"' . $singacco->tipo_pax . '";"' . $singacco->accomodation . '";"' . $singacco->contot . '";"' . $singbk["status"] . '";"' . $singbk["data_scadenza"] . '";"' . $singbk["data_insert"] . '";' . str_replace(".", ",", $singbk["acconto_versato"]) . ';' . str_replace(".", ",", $singbk["saldo_versato"]) . ';"' . $singbk["valuta"] . '"' . PHP_EOL;
                        //echo "<br />".$rigaData."<br />";
                        fwrite($fh, $rigaData);
                    }
                }
