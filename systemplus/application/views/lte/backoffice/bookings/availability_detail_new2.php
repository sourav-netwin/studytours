              ...
              <ul class="nav nav-pills" role="tablist">
                <li role="presentation" class="active">
                    <a href="#d" style="cursor: default;" data-toggle="pill">
                        <span class="glyphicon glyphicon-calendar"></span> Availability on <?php echo $campusname ?> from <?php echo date("d/m/Y", strtotime($datein)) ?> to <?php echo date("d/m/Y", strtotime($dateout)) ?>
                    </a>
                </li>
            </ul>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="rigaAvail">
                                                ...
                                                foreach ($simcalendar[$a] as $cAva) {
                                                    ?>
                                                    <td><input id="<?php echo $_REQUEST["accomodation"][$a] ?>_totava_<?php echo strtotime($datecycle) ?>" type="text" class="form-control nobbg" readonly value="<?php echo $cAva["totale"] ?>"></td>
                                                    <?php
                                                    $datecycle = date("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
                                                }
                                                ?>	
                                            ...
                                            <tr>
                                                ...
                                                while (strtotime($datecycle) <= strtotime($dateout)) {
                                                    ?>
                                                    <td><input class="form-control nobbg" type="text" readonly id="<?php echo $_REQUEST["accomodation"][$a] ?>_totpax_<?php echo strtotime($datecycle) ?>" value="0"></td>
                                                    <?php
                                                    $datecycle = date("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
                                                }
                                                ?>	
                                            ...
                                            <tr class="avalRow">
                                                ...
                                                while (strtotime($datecycle) <= strtotime($dateout)) {
                                                    ?>
                                                    <td class="text-center"><input class="form-control nobbg" type="text" readonly id="<?php echo $_REQUEST["accomodation"][$a] ?>_leftava_<?php echo strtotime($datecycle) ?>" value="0"></td>
                                                        <?php
                                                        $datecycle = date("Y-m-d", strtotime("+1 day", strtotime($datecycle)));
                                                    }
                                                    ?>	
