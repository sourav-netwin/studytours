...
<!--                            <div class="box-tools pull-right sort-text">
            ...
            <div class="box-footer">
                <div class="pull-right">
                    <input class="btn btn-primary mr-bot-5" type="button" name="inviaO" id="inviaO" value="Retrieve data" />
                    <input class="btn btn-primary mr-bot-5" type="button" name="inviaO2" id="inviaO2" value="Test overnight (do not use)" />
                </div>
            </div>
            <!-- /.box-footer-->
          </div>
